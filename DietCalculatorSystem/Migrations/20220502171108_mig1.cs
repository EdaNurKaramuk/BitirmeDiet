        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalProteins = table.Column<double>(type: "float", nullable: true),
                    TotalFats = table.Column<double>(type: "float", nullable: true),
                    TotalCarbohydrates = table.Column<double>(type: "float", nullable: true),
                    BreakfastCalories = table.Column<double>(type: "float", nullable: true),
                    BreakfastProteins = table.Column<double>(type: "float", nullable: true),
                    BreakfastFats = table.Column<double>(type: "float", nullable: true),
                    BreakfastCarbohydrates = table.Column<double>(type: "float", nullable: true),
                    LunchCalories = table.Column<double>(type: "float", nullable: true),
                    LunchProteins = table.Column<double>(type: "float", nullable: true),
                    LunchFats = table.Column<double>(type: "float", nullable: true),
                    LunchCarbohydrates = table.Column<double>(type: "float", nullable: true),
                    DinnerCalories = table.Column<double>(type: "float", nullable: true),
                    DinnerProteins = table.Column<double>(type: "float", nullable: true),
                    DinnerFats = table.Column<double>(type: "float", nullable: true),
                    DinnerCarbohydrates = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TotalFood", x => new { x.DietId, x.FoodId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TotalFood_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
