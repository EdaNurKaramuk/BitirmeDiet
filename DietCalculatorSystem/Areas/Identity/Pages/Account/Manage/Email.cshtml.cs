    ...
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "E-mail değiştirmek için onay linki gönderildi. Lütfen e-mail'inizi kontrol edin.";
                return RedirectToPage();
            }

            StatusMessage = "E-mail'iniz değiştirilmedi.";
            return RedirectToPage();
        }
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = "Doğrulama maili gönderildi. Lütfen e-mail'inizi kontrol ediniz.";
            return RedirectToPage();
        }
    }
}
